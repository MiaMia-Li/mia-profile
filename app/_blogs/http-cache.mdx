...
第一次请求  
![](/static/images/cache200.png)  
第二次请求  
![](/static/images/cache304.png)
...
![](/static/images/last-modified.png)
...
![](/static/images/if-modified-since.png)
...
![](/static/images/if-none-match.png)
...
- [http 协议缓存机制](https://segmentfault.com/a/1190000010690320)
- [从输入 URL 到页面加载的过程](http://www.dailichun.com/2018/03/12/whenyouenteraurl.html)
